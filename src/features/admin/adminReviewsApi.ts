...
let devAdminReviews: AdminReview[] = [
  ...
  },
  {
    ...
    productId: 'mod-p1',
    imageUrls: [
      'https://picsum.photos/seed/remera1/600/600',
      'https://picsum.photos/seed/remera2/600/600'
    ],
    store: { id: 'store-001', businessName: 'Outlet Avellaneda Norte' },
  ...
  },
  {
    ...
    productId: 'mod-p2',
    imageUrls: [
      'https://picsum.photos/seed/buzo1/600/600',
      'https://picsum.photos/seed/buzo2/600/600',
      'https://picsum.photos/seed/buzo3/600/600'
    ],
    store: { id: 'store-002', businessName: 'Moda Flores Local' },
  ...
  },
  {
    ...
    productId: 'mod-p5',
    imageUrls: [
      'https://picsum.photos/seed/zapa1/600/600',
      'https://picsum.photos/seed/zapa2/600/600',
      'https://picsum.photos/seed/zapa3/600/600',
      'https://picsum.photos/seed/zapa4/600/600'
    ],
    store: { id: 'store-004', businessName: 'Nuevo Local Palermo' },
  ...
  },
  {
    ...
    productId: 'mod-p5',
    imageUrls: [
      'https://picsum.photos/seed/zapa5/600/600'
    ],
    store: { id: 'store-004', businessName: 'Nuevo Local Palermo' },
    product: { id: 'mod-p5', name: 'Zapatilla urbana multicolor' },
    buyer: {
...
export async function fetchBuyerReviewHistory(buyerId: string): Promise<BuyerReviewHistory> {
  ...
  const reviews = reviewsRaw
    .map((row) => {
      ...
      const imgsRaw = entry.imageUrls ?? entry.image_urls;
      const imageUrls: string[] = [];
      if (productId && Array.isArray(imgsRaw)) {
        for (const url of imgsRaw) {
          if (typeof url === 'string' && url.trim().length > 0) {
            imageUrls.push(url.trim());
          }
        }
